...
public class Exercicio14 {
	...
	public static void main(String[]args){
		...
		case 1:
			...
			adicao = n1 + n2;
			JOptionPane.showConfirmDialog(null, "A valor da soma é de:  " + adicao);
		case 2:
			...
			subitracao = n3 - n4;
			JOptionPane.showConfirmDialog(null, "A valor da soma é de:  " + subitracao);
		case 3:
			...
			divisao = n5 + n6;
			JOptionPane.showConfirmDialog(null, "A valor da soma é de:  " + divisao);
		case 4:
			double mult, n7, n8;
			...
			mult = n7 + n8;
			JOptionPane.showConfirmDialog(null, "A valor da soma é de:  " + mult);
		case 5:
			...
			JOptionPane.showConfirmDialog(null,"O valor do fatorial é de: "+ fat);
		case 6:
			...
			valor = base^exp;
			JOptionPane.showConfirmDialog(null, "O seu valor é de: " + valor);
		case 7:
			JOptionPane.showConfirmDialog(null, "Comando invalido");
		}
	}
}